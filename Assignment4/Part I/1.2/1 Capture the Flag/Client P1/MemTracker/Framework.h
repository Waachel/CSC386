...
//       Properties / General / Advanced / Character SetCharAtPos->Use Multi - Byte Character SetCharAtPos
//
...
#pragma warning( push )
	#pragma warning( disable : 4820 ) // 'bytes' bytes padding added after construct 'member_name'
	#define NOMINMAX
	#ifndef WIN32_LEAN_AND_MEAN			// For compatibility with using Winsock2
